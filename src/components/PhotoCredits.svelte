<div class="accordion arrows">
  <label for="acc-close" class="hidden">Accordion menu</label>
  <input type="radio" name="accordion" id="cb1" />
  <section class="box">
    <label class="box-title" for="cb1">Photo Credits</label>
    <label class="box-close" for="acc-close"></label>
    <div class="box-content">
      <h3>Header Cover (From left to right)</h3>
...
<style lang="scss">
  ...
  @use "../scss/components/photo-credits";
</style>
