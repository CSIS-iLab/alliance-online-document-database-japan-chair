...
<div class="wrapper">
  <main class="container intro-content">
    ...
    <p class="show-on-mobile intro-content__overline--regular">Alliance Online</p>
    <h1 class="show-on-mobile intro-content__title">U.S.-Japan Policy Database</h1>
...
<main class="container mobile intro-content intro-content--mobile">
  ...
  <!-- <p class="intro-content__overline--regular">Alliance Online</p>
  <h1 class="intro-content__title">U.S.-Japan Policy Database</h1> -->
